...
def user_update_command(username:str, newPassword: Annotated[str, typer.Option(prompt=False, hide_input=True, "-pw")]=None, deactivate: Annotated[bool, typer.Option("-d")]=None, newUsername:Annotated[str, typer.Option("-u")]=None) -> None:
    session = connect_to_db()
