...
def user_update_command(username:str, newPassword: Annotated[bool, typer.Option(hide_input=True)], newState: Annotated[bool, typer.Option()], newUsername:Annotated[str, typer.Option()]) -> None:
    session = connect_to_db()
    if newUsername:
